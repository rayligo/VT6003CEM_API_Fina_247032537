...
exports.listFav = exports.removeFav = exports.addFav = void 0;
const db = __importStar(require("../helpers/database"));
//add a user Favorite
const addFav = (id, uid) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield db.run_query(query, [id, uid]);
...
//remove a fav record
const removeFav = (id, uid) => __awaiter(void 0, void 0, void 0, function* () {
    let query = `DELETE FROM favs WHERE articleid=${id} AND userid=${uid} ;`;
    try {
        yield db.run_query(query, [id, uid]);
...
const listFav = (id) => __awaiter(void 0, void 0, void 0, function* () {
